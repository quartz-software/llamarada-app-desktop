...
import { StockUpdateSchema } from "@/shared/schemas/models/stock";
...
const StockModalEdit: FC<StockModalProps> = ({
  item,
  open,
  setOpen,
  onSave,
}) => {
  type StockType = z.infer<typeof StockUpdateSchema>;
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Modifica los datos del producto</DialogTitle>
          <DialogDescription>
            Despues de odificar los datos y haz clic en "Guardar" para registrar el producto.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
                  ...
                  <div className="col-span-3">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="3">Mantenimineto</SelectItem>
